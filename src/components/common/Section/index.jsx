...
export const Section = ({ id, className, children, background, color }) => {
    ...
    return (
        <div style={{...{color: variables[`${color}_color`]}, ...getBackgroundStyle()}} id={id} className={`section${className || ''}`}>
            {children}
        </div>
    )
}
